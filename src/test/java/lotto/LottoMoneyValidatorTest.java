...
class LottoMoneyValidatorTest {
    ...
    private void assertThrowWithMessage(String inputMoney, String expectedMessage) {
        Assertions.assertThatThrownBy(() -> LottoMoneyValidator.validateThousandUnit(inputMoney))
